...
```shell
$ npm install vue-just-datepicker
```
...
```javascript
import Vue from 'vue';
import Datepicker from 'vue-just-datepicker';
...
```html
<datepicker :chooseDate.sync="date"></datepicker>
```

##is-visible.sync
Get visibility of component
```html
<datepicker :is-visible.sync="datepickerVisible"></datepicker>
```
